...
<body>
        ...
        <header id="header">
            ...
            <ul>
                ...
                <li class="dropdown">
                <a href="#" class="dropdown-toggle active" >Category<i class="fas fa-caret-down"></i></a>
                <ul class="dropdown-menu">
                    <!-- Example dropdown items (replace with actual categories) -->
                    <li><a href="kurtis.php">Kurtis</a></li>
                    <li><a href="kurti-pair.php" >Kurti Pair</a></li>
                    <li><a href="short-kurti.php" class="active">Short Kurtis</a></li>
                </ul>
                </li>
